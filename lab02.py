...
print(add_three(5))
curried_mul=lambda_curry2(mul)
print(curried_mul(6)(7))
print('第二个函数')
####
count_factors = count_cond(lambda n, i: n % i == 0)
print(count_factors(2),count_factors(4),count_factors(12))
is_prime = lambda n, i: count_factors(i) == 2
count_prime=count_cond(is_prime)
print(count_prime(2),count_prime(3),count_prime(4),count_prime(5),count_prime(20))
print('第三个')
add_one = lambda x: x + 1        # adds one to x
square = lambda x: x**2
b1 = composite_identity(square, add_one)
